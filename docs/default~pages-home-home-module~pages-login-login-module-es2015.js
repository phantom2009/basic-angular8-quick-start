...
let HttpClientService = HttpClientService_1 = class HttpClientService {
     ...
     */
    static handleSuccess(response, handleAlert = alert) {
    ...
    static handleError(errorResponse, handleAlert = alert) {
    ...
    get(url, data, options) {
        ...
        const isUseTimeStamp = lodash__WEBPACK_IMPORTED_MODULE_4__["get"](options, 'timeStamp');
        if ((isUseTimeStamp !== false && this.unofficial) ||
            isUseTimeStamp === true) {
            // 开发环境默认添加时间戳
            params = params.append('_t', new Date().getTime().toString());
        }
        //token处理
        const user = JSON.parse(window.localStorage.getItem(_utils_Constants__WEBPACK_IMPORTED_MODULE_7__["tokenKey"]));
        if (user && user.username) {
            HttpClientService_1.headers["Access-Token"] = user.token;
        }
        return this.httpClient
            .get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + url, 
        // @ts-ignore-next-line
        lodash__WEBPACK_IMPORTED_MODULE_4__["merge"]({
            ...
            params
        }, options)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])((response) => {
            ...
            return HttpClientService_1.handleSuccess(response, this.errorMsg);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])((errorResponse) => {
            if (!lodash__WEBPACK_IMPORTED_MODULE_4__["get"](options, 'ignoreErrorCheck')) {
                HttpClientService_1.handleError(errorResponse, this.errorMsg);
            }
    ...
    post(url, data, options) {
        ...
        return this.httpClient
            .post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + url, data, 
        // @ts-ignore-next-line
        lodash__WEBPACK_IMPORTED_MODULE_4__["merge"]({
            reportProgress: true,
            observe: 'response',
...
HttpClientService = HttpClientService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
